...
#weights between layer 1 (as a matrix representation)
w1 = np.array([[0.2, 0.2, 0.2], [0.4, 0.4, 0.4], [0.6, 0.6, 0.6]])
#weigts layer 2
w2 = np.zeros((1, 3))
w2[0,:] = np.array([0.5, 0.5, 0.5])
#dummy values in the layer 1 bias weight array/vector, and the layer 2 bias weight
...
#IPython function -> increased speed 
